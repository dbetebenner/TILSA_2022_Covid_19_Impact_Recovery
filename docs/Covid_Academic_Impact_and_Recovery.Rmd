...
date: >- 
  June 30th, 2022<br>CCSSO ASR-TILSA 2022<br>Summer Meeting

   ```{r, github-corner, echo=FALSE, results='asis'}
     cat(cfaDocs:::makeOctoCat(
       link='https://github.com/dbetebenner/TILSA_2022_Covid_19_Impact_Recovery/blob/main/docs/Covid_Academic_Impact_and_Recovery.Rmd'))
   ```
output:
  cfaDocs::cfaXaringan:
    include: !expr list(
      footer = 'default',
      footer_text = '<a class=\"footer\" href=\"https://dbetebenner.github.io/TILSA_2022_Covid_19_Impact_Recovery\">COVID-19 Academic Impact and Recovery</a>',
...
meta() %>%
  meta_general(
    description = "Presentation on COVID-19 Academic Impact and Recovery given as part of CCSSO TILSA Summer 2022 Meeting, Atlanta Georgia",
    subject = "COVID-19 Academic Impact and Recovery",
    generator = "xaringan and remark.js",
    theme_color = "#b6e202"
  ) %>% 
  meta_name("github-repo" = "dbetebenner/TILSA_2022_Covid_19_Impact_Recovery") %>% 
  meta_social(
    title = "COVID-19 Academic Impact and Recovery • CCSSO TILSA Summer 2022 • Damian Betebenner",
    url = "https://dbetebenner.github.io/TILSA_2022_Covid_19_Impact_Recovery/Covid_Academic_Impact_and_Recovery",
    image = "https://github.com/dbetebenner/TILSA_2022_Covid_19_Impact_Recovery/raw/main/docs/Figures/TITLE_SLIDE_image.png",
    image_alt = "Title slide for COVID-19 Academic Impact and Recovery presentation",
    og_type = "article",
    og_locale = "en_US",
...
#### <center><span style="color: red;">Where would student(s) have been had the pandemic not occurred?</span></center>
